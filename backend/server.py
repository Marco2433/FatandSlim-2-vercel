...
# Import YouTube videos from utils
from utils.youtube_videos import get_videos_with_dates

# Get workout videos dynamically
def get_workout_videos_list():
    return get_videos_with_dates()
...
async def stream_workout_video(video_id: str, request: Request):
    """Proxy pour les vidéos workout - Retourne l'URL de redirection"""
    import httpx
    ...
    # Redirect directement vers la source vidéo
    ...
    return JSONResponse(
        content=[{
            ...
            "target": {
                ...
                "sha256_cert_fingerprints": ["FC:60:08:CA:12:D9:BC:DA:C1:A2:64:A1:7A:95:24:98:A5:E3:35:14:A4:89:D9:71:AD:F0:4C:9B:B8:11:A3:8A"]
            }
        }],
        headers={
            "Cache-Control": "no-cache, no-store, must-revalidate"
...
async def calendar_oauth_callback(code: str, state: str):
    ...
    # Redirect to app
    frontend_url = os.environ.get('FRONTEND_URL', 'https://fatslim-community.preview.emergentagent.com')
